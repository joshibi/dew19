...
function startLoop(audioBuffer, pan=0, rate=1) {
  ...
  sourceNode.loopStart = 1.85;
  sourceNode.loopEnd = 3.5;
...
fetch('assets/sounds/BasketballBounceAndRoll.mp3')
...
.then(function(audioBuffer){
  startLoop(audioBuffer,-1,1.25);
  startLoop(audioBuffer,　1, 1.15);
})
.catch(function(e){
